      ...
      >
        ...
        <div
          style={{
            ...
            right: 0,
            height: "2px",
            background: "linear-gradient(90deg, transparent, rgba(96,165,250,0.4), rgba(168,85,247,0.3), transparent)",
          }}
        />
        ...
        >
          ...
          >
            LLMs, agents, RAG, code execution, image gen — running
            entirely on your GPU. No server. No API keys. 100% private.
          </div>
        ...
        >
          <div style={{ fontSize: "15px", color: "#52525b" }}>
            WebGPU · Ollama · Cloud API
          </div>
          <div style={{ fontSize: "15px", color: "#52525b" }}>
