...
import { createChatMessageId, type ChatMessageMeta, type ChatProvider, useChatStore } from "@/lib/chat/useChatStore";
import { useSystemPrompt } from "@/lib/chat/useSystemPrompt";
import { tick as keySoundTick } from "@/lib/media/useKeySound";
import { useAgent, AgentToolkit } from "@/lib/runtime/useAgent";
import { routeMessage, classifyComplexity, type RouteDecision } from "@/lib/chat/useAutoRouter";
